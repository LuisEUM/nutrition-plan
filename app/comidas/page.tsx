...
export default function LunchesPage() {
  ...
  const recipesByGoal = filteredRecipes.reduce(
    ...
    {} as Record<string, typeof lunchRecipes>
  );

  return (
    <div className='container mx-auto py-10'>
      <h1 className='text-4xl font-bold mb-8'>Opciones de Comida</h1>

      <SearchRecipes recipes={lunchRecipes} onSearch={setFilteredRecipes} />
