...
export default function BreakfastsPage() {
  ...
  const recipesByGoal = filteredRecipes.reduce(
    ...
    {} as Record<string, typeof breakfastRecipes>
  );

  return (
    <div className='container mx-auto py-10'>
      <h1 className='text-4xl font-bold mb-8'>Opciones de Desayuno</h1>

      <SearchRecipes recipes={breakfastRecipes} onSearch={setFilteredRecipes} />
