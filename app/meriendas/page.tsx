...
export default function AfternoonSnacksPage() {
  const [filteredRecipes, setFilteredRecipes] =
    useState<Recipe[]>(snackRecipes);
  ...
  const recipesByGoal = filteredRecipes.reduce(
    ...
    {} as Record<string, typeof snackRecipes>
  );

  return (
    <div className='container mx-auto py-10'>
      <h1 className='text-4xl font-bold mb-8'>Opciones de Merienda</h1>

      <SearchRecipes recipes={snackRecipes} onSearch={setFilteredRecipes} />
